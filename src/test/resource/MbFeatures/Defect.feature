#IN THE FIFTH SCENARIO SAMPLE REPORT DOES NOT GENERATED FOR EVERY CONSULTANT IN VASTU PAGE
@defect
Feature: Vastu Functionality Validation
Scenario: Validate Vastu Consultant Report Functionality
